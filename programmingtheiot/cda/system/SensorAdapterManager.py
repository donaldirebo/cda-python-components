...
class SensorAdapterManager(object):
	...
	def handleTelemetry(self):
		"""
		Collects telemetry from all sensor adapters and forwards to listener.
		"""
	...
	def startManager(self):
		"""
		Starts the sensor adapter manager scheduler.
	...
	def stopManager(self):
		"""
		Stops the sensor adapter manager scheduler.
