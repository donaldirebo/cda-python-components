...
DEFAULT_CONFIG_FILE_NAME = '/home/donald/piot/cda-python-components/config/PiotConfig.props'
...
HANDLE_TILT_CHANGE_ON_DEVICE_KEY = 'handleTiltChangeOnDevice'
TRIGGER_TILT_MAX_ANGLE_KEY = 'triggerTiltMaxAngle'
TILT_MAX_TIME_PAST_THRESHOLD_KEY = 'tiltMaxTimePastThreshold'
...
# Additional accelerometer axis sensors
PITCH_SENSOR_NAME = 'PitchSensor'
ROLL_SENSOR_NAME = 'RollSensor'
YAW_SENSOR_NAME = 'YawSensor'
